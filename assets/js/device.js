...
const throwError = () => {
	createModal(`
			<h3 class='fas fa-info'></h3>
				...
				<p>If you are using a smartphone and the game is not working, ensure you are not in desktop mode. If the issue persists, kindly contact the developer <a href='mailto: codinglabz20@gmail.com'>here</a></p>
			`)
}
